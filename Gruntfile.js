...
module.exports = function (grunt) {
    ...
    watch: {
      ...
      livereload: {
        ...
        files: [
          '<%= yeoman.exp %>/{,*/}*.html',
          '.tmp/styles/{,*/}*.css',
          '<%= yeoman.exp %>/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg}'
        ]
      }
    },
  ...
  grunt.registerTask('build', [
    ...
    'concat',
    'ngmin',
    // Uncomment for CSS to be included
    // 'cssmin',
    'uglify',
    'usemin',
    'htmlmin'
